...
public class SubscribePublishToFromTopicTest {
  ...
  public void functionsPubsubSubscribe_shouldPrintPubsubMessage() throws Exception {
    String msg = "upstream-downstream";
    ...
    new SubscribePublishToFromTopic().accept(event);

    assertThat("Decoded data:" + msg + "!").isEqualTo(
